...
class Cards {
    ...
    val deckImgaesRef: Map<Int,Int> = mapOf(1 to R.drawable.ace_of_spades,2 to R.drawable.two_of_spades,3 to R.drawable.three_of_spades,4 to R.drawable.four_of_spades,
        ...
        13 to R.drawable.king_of_spades2,14 to R.drawable.ace_of_hearts,15 to R.drawable, 16 to R.drawable.three_of_hearts,
